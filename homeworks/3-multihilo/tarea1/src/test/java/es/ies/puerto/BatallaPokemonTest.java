...
public class BatallaPokemonTest {
    ...
    void BatallaPokemonDebeHaberGanador() {
        ...
        "El output debe contener un ganador de la batalla.");
        assertTrue(batalla.isJuegoTerminado() == true, 
        "El juego debe estar marcado como terminado.");
        assertTrue(batalla.getHpPikachu() <= 0 || batalla.getHpCharmander() <= 0, 
        "Al menos un Pokemon debe tener HP menor o igual a 0.");
    }
}
